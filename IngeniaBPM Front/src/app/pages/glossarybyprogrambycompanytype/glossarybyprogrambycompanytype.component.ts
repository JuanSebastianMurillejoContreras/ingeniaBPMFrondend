...
@Component({
    selector: 'app-glossarybyprogrambycompanytype',
    standalone: true,
    templateUrl: './glossarybyprogrambycompanytype.component.html',
    styleUrls: ['./glossarybyprogrambycompanytype.component.css'],
    imports:[MaterialModule, RouterLink, RouterOutlet]
})
export class GlossarybyprogrambycompanytypeComponent implements OnInit{
