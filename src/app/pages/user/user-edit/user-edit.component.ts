...
export class UserEditComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.form = new FormGroup( {
      ...
      'telephone': new FormControl( '', [Validators.minLength( 7 ), Validators.maxLength( 10 )] ),
      ...
      'companyPosition': new FormControl( '', [Validators.required, Validators.minLength( 5 ), Validators.maxLength( 20 )] ),
